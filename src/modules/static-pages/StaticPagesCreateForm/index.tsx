...
import { StaticPagesForm } from '../StaticPagesForm';

export type IStaticPageCreateForm = {} & ICreateRenderForm;

export const StaticPageCreateForm = ({
  form,
  handleSubmit,
  handleValidate,
}: IStaticPageCreateForm) => {
  return (
    <S.BaseForm>
      <S.FormContent className={classnames('flex', 'justify-between')}>
        <StaticPagesForm form={form} handleSubmit={handleSubmit} />
        <Image
          maxWidth="600px"
          maxHeight="500px"
          alt="form_image"
